...
public class Mymensingh extends JFrame{
	...
	public Mymensingh() {
		...
		setLayout(null);
	     ...
	     inputpanel.setBackground(new Color(182, 141, 188));
	     ...
	     img1 = new ImageIcon(getClass().getResource("Medium-Prawn1.jpg"));
			...
			JLabel l1 = new JLabel("Prawn");
	         ...
	         JLabel l2 = new JLabel("Price(Per kg):620 Taka");
		     ...
		     JLabel l4= new JLabel("Price(Per kg):270 Taka");
         ...
         JLabel l6= new JLabel("Price(Per kg):850 Taka");
