...
public class Barishal extends JFrame{
	...
	public Barishal () {
		...
		setLayout(null);
	     ...
	     inputpanel.setBackground(new Color(203, 170, 192));
	     ...
	     img1 = new ImageIcon(getClass().getResource("Medium-Prawn1.jpg"));
			...
			JLabel l1 = new JLabel("Prawn");
	         ...
	         JLabel l2 = new JLabel("Price(Per kg):600 Taka");
         ...
         JLabel l6= new JLabel("Price(Per kg):800 Taka");
         ...
         inputpanel.add(l6);
	        ...
	        JLabel l8= new JLabel("Price(Per kg):150 Taka");
	        ...
	        JLabel l10= new JLabel("Price(Per kg):250 Taka");
         ...
         img6 = new ImageIcon(getClass().getResource("Goat1.jpg"));
	        ...
	        JLabel l12= new JLabel("Price(Per kg):600 Taka");
	        ...
	        JLabel l14= new JLabel("Price(Per Haley):30 Taka");
	        ...
	        JLabel l16= new JLabel("Price(Per kg):30 Taka");
	        ...
	        JLabel l18= new JLabel("Price(Per kg):110 Taka");
