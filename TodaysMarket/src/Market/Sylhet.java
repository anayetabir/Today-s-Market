...
public class Sylhet extends JFrame{
	...
	public Sylhet() {
		...
		setLayout(null);
	     ...
	     inputpanel.setBackground(new Color(26, 191, 110));
	     ...
	     img1 = new ImageIcon(getClass().getResource("Medium-Prawn1.jpg"));
			...
			JLabel l1 = new JLabel("Prawn");
	         ...
	         JLabel l2 = new JLabel("Price(Per kg):650 Taka");
		     ...
		     JLabel l4= new JLabel("Price(Per kg):250 Taka");
