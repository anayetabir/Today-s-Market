...
public class Rajshahi extends JFrame{
	...
	public Rajshahi () {
		...
		setLayout(null);
	     ...
	     inputpanel.setBackground(new Color(243, 191, 188));
         ...
         img6 = new ImageIcon(getClass().getResource("Goat1.jpg"));
	        ...
	        JLabel l14= new JLabel("Price(Per Haley):25 Taka");
	        ...
	        JLabel l16= new JLabel("Price(Per kg):35 Taka");
	        ...
	        JLabel l18= new JLabel("Price(Per kg):100 Taka");
