...
public class Khulna extends JFrame{
	...
	public Khulna () {
		...
		setLayout(null);
	     ...
	     inputpanel.setBackground(new Color(16, 249, 191));
         ...
         JLabel l6= new JLabel("Price(Per kg):750 Taka");
         ...
         inputpanel.add(l6);
	        ...
	        JLabel l8= new JLabel("Price(Per kg):155 Taka");
         ...
         img6 = new ImageIcon(getClass().getResource("Goat1.jpg"));
	        ...
	        JLabel l18= new JLabel("Price(Per kg):115 Taka");
