...
public class Rangpur extends JFrame{
	...
	public Rangpur () {
		...
		setLayout(null);
	     ...
	     inputpanel.setBackground(new Color(139, 252, 54));
         ...
         inputpanel.add(l6);
	        ...
	        JLabel l10= new JLabel("Price(Per kg):350 Taka");
         ...
         img6 = new ImageIcon(getClass().getResource("Goat1.jpg"));
	        ...
	        JLabel l16= new JLabel("Price(Per kg):45 Taka");
	        ...
	        JLabel l18= new JLabel("Price(Per kg):125 Taka");
